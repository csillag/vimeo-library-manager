...
export function wrapPromiseAsync0<Result>(
  ...
  const simpleFunction: SimpleFunction<Result> = () =>
    Future.task(() => futureFunction().wait() as Result).wait();
...
type FuncWithCallback2<D1, D2, T> = (
  data1: D1,
  data2: D2,
...
export function wrapPromiseAsync2<Data1, Data2, Result>(
  ...
  const simpleFunction: SimpleFunction2<Data1, Data2, Result> = (
    data1: Data1,
    data2: Data2
...
type PromiseFunction3<D1, D2, D3, T> = (
  data1: D1,
  data2: D2,
  data3: D3
) => Promise<T>;
type FuncWithCallback3<D1, D2, D3, T> = (
  data1: D1,
  data2: D2,
  data3: D3,
  callback: AsyncCallback<T>
...
export function wrapPromiseAsync3<Data1, Data2, Data3, Result>(
  ...
  const simpleFunction: SimpleFunction3<Data1, Data2, Data3, Result> = (
    data1: Data1,
    data2: Data2,
    data3: Data3
  ) =>
    Future.task(
      () => futureFunction(data1, data2, data3).wait() as Result
    ).wait();
