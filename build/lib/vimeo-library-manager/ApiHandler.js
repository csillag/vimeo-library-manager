...
exports.videoUriToId = function (uri) {
  return uri.substr(8);
};
...
var ApiHandler = /** @class */ (function () {
  ...
  Object.defineProperty(ApiHandler.prototype, "_vimeo", {
    get: function () {
      if (this._vimeoClient === undefined) {
        this._vimeoClient = new vimeo_access_sync_1.SyncApiHandler(
          this._session,
          {
  ...
  ApiHandler.prototype.startLogin = function (config) {
    this._checkLoginConfig();
    var noWebServer = config.noWebServer,
      noBrowserLaunch = config.noBrowserLaunch;
  ...
  ApiHandler.prototype.uploadVideo = function (videoFileName, data, config) {
    ...
    var waitForEncoding = config.waitForEncoding,
    ...
    util_1.slow("uploading video file", function (control) {
      uri = _this._vimeo.uploadVideo(videoFileName, data, function (
        uploaded,
        total
      ) {
        control.setText(
  ...
  ApiHandler.prototype.deleteVideo = function (videoId) {
    ...
    util_1.slow("deleting video", function () {
      return _this._vimeo.deleteVideo(videoId);
    });
  };
  ApiHandler.prototype.replaceVideoContent = function (
    videoId,
    videoFileName,
    config
  ) {
    ...
    var waitForEncoding = config.waitForEncoding,
      openInBrowser = config.openInBrowser,
      keepThumbnail = config.keepThumbnail,
      thumbnailTime = config.thumbnailTime,
    ...
    util_1.slow("uploading video file", function (control) {
      _this._vimeo.replaceVideo(videoId, videoFileName, function (
        uploaded,
        total
      ) {
        control.setText(
